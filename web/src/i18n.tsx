...
const messages: Messages = {
  ...
  navWarmup: { zh: '预热监控', en: 'Warmup Monitor' },
  ...
  headerWarmup: { zh: '预热监控', en: 'Warmup Monitor' },
  warmupRuns: { zh: '预热次数', en: 'Runs' },
  warmupSuccess: { zh: '成功', en: 'Successes' },
  warmupSuccessRate: { zh: '成功率', en: 'Success Rate' },
  warmupFail: { zh: '失败', en: 'Failures' },
  warmupStartTime: { zh: '开始时间', en: 'Start Time' },
  warmupLastRun: { zh: '上次预热', en: 'Last run' },
  warmupLastSuccess: { zh: '上次成功', en: 'Last success' },
  warmupLastError: { zh: '最近错误', en: 'Last error' },
  warmupRecent: { zh: '最近记录', en: 'Recent records' },
  warmupRecentHint: { zh: '仅显示最近 10 条记录', en: 'Showing latest 10 records' },
  warmupDuration: { zh: '耗时', en: 'Duration' },
  warmupActions: { zh: '执行动作', en: 'Actions' },
  warmupErrors: { zh: '错误', en: 'Errors' },
  warmupEmpty: { zh: '暂无预热记录', en: 'No warmup records yet' },
  warmupRunNow: { zh: '立即预热', en: 'Run now' },
  ...
  resourcesTitle: { zh: 'A/B 实验插件线上使用', en: 'A/B Experiment Serving Plugin Live Usage' },
  markFailed: { zh: '标记失败', en: 'Mark failed' },
  manualFailReason: { zh: '手动标记为失败', en: 'Manually marked as failed' },
  markFailedHint: { zh: '仅运行中可标记失败', en: 'Only running traces can be marked failed' },
  previewPlugin: { zh: 'A/B 实验插件预览', en: 'A/B Experiment Serving Plugin Preview' },
  personalWebsite: { zh: '个人网站', en: 'Personal Site' },
  githubRepo: { zh: 'GitHub 仓库', en: 'GitHub Repo' },

  // Plugin Preview Page
  widgetConfig: { zh: '⚙️ 插件配置', en: '⚙️ Widget Configuration' },
  widgetConfigHint: { zh: '配置实验参数，预览插件效果', en: 'Configure experiment parameters and preview widget' },
  widgetScriptUrl: { zh: 'Widget Script URL', en: 'Widget Script URL' },
  widgetScriptHint: { zh: 'Vercel 每次部署会生成新的文件名。本地测试可使用:', en: 'Vercel generates new filename on each deployment. Use for local testing:' },
  apiBaseUrl: { zh: 'API Base URL', en: 'API Base URL' },
  quickSwitch: { zh: '快速切换：', en: 'Quick switch:' },
  localDev: { zh: '本地开发', en: 'Local Dev' },
  production: { zh: '线上环境', en: 'Production' },
  selectActiveExperiment: { zh: '选择已激活的实验', en: 'Select Active Experiment' },
  noActiveExperiments: { zh: '无已激活的实验', en: 'No active experiments' },
  pleaseSelectExperiment: { zh: '请选择实验', en: 'Please select' },
  noActiveExperimentsHint: { zh: '没有已激活的实验，请先在', en: 'No active experiments, please activate one in' },
  activateExperimentHint: { zh: '中激活一个实验', en: 'first' },
  selected: { zh: '已选择:', en: 'Selected:' },
  userKeyOptional: { zh: 'User Key（可选）', en: 'User Key (Optional)' },
  userKeyHint: { zh: '用于标识用户，不填则使用匿名 ID', en: 'Used to identify users, anonymous ID will be used if not provided' },
  enableRandomAssignment: { zh: '启用随机分配', en: 'Enable Random Assignment' },
  randomAssignmentHint: { zh: '开启后每次刷新都会重新分配变体（用于测试）', en: 'Reassign variant on each refresh (for testing)' },
  loadPreview: { zh: '加载预览', en: 'Load Preview' },
  livePreview: { zh: '🎨 实时预览', en: '🎨 Live Preview' },
  previewLoaded: { zh: '✅ 预览已加载，查看下方效果', en: '✅ Preview loaded, check below' },
  clickToLoadPreview: { zh: '点击"加载预览"按钮开始', en: 'Click "Load Preview" to start' },
  ready: { zh: '准备就绪', en: 'Ready' },
  configureAndLoad: { zh: '配置好参数后，点击"加载预览"按钮', en: 'Configure parameters and click "Load Preview"' },
  viewWidgetEffect: { zh: '查看实验插件的真实效果', en: 'View the actual widget effect' },
  integrationCode: { zh: '📦 集成代码', en: '📦 Integration Code' },
  integrationCodeHint: { zh: '复制以下代码到您的网站即可使用', en: 'Copy the code below to your website' },
  copyIntegrationCode: { zh: '复制集成代码', en: 'Copy Integration Code' },
  integrationTips: { zh: '💡 集成提示', en: '💡 Integration Tips' },
  integrationTip1: { zh: '将上述代码放在 HTML 的 <body> 标签内即可', en: 'Place the code inside HTML <body> tag' },
  integrationTip2: { zh: '插件会自动创建 #exp-widget-root 元素并渲染内容', en: 'Widget will auto-create #exp-widget-root element and render content' },
  integrationTip3: { zh: '使用 Shadow DOM 隔离样式，不会影响您的网站', en: 'Uses Shadow DOM for style isolation, won\'t affect your site' },
  integrationTip4: { zh: '自动追踪曝光和点击，无需额外配置', en: 'Auto-tracks impressions and clicks, no extra config needed' },
  loadFailed: { zh: '加载失败:', en: 'Load failed:' },
  checkApiBaseUrl: { zh: '请检查 API Base URL 是否正确，或者后端服务是否运行中', en: 'Please check if API Base URL is correct or if backend is running' },
  loadedFrom: { zh: '已从', en: 'Loaded from' },
  loaded: { zh: '加载', en: 'loaded' },
  activeExperimentsCount: { zh: '个激活的实验', en: 'active experiments' },
  pleaseSelectExperimentFirst: { zh: '请先选择一个实验！', en: 'Please select an experiment first!' },
  integrationCodeCopied: { zh: '✅ 集成代码已复制到剪贴板！', en: '✅ Integration code copied to clipboard!' },
  experimentConfig: { zh: '📋 实验配置', en: '📋 Experiment Configuration' },
  widgetPreviewArea: { zh: '🎨 插件预览区域（Widget 将自动渲染在右侧）', en: '🎨 Widget Preview Area (Widget will auto-render on the right)' },
  loadAssetsFailed: { zh: '获取素材列表失败', en: 'Failed to fetch assets' },
  loadAssetsError: { zh: '加载素材失败: {msg}', en: 'Failed to load assets: {msg}' },
  unnamedCreative: { zh: '未命名创意', en: 'Untitled creative' },
  assetPlaceholder: { zh: '素材图片', en: 'Asset image' },
  assetCountBadge: { zh: '{n} 张', en: '{n} imgs' },
  styleTag: { zh: '风格: {style}', en: 'Style: {style}' },
  activityLoadFailed: { zh: '加载最近活动失败', en: 'Failed to load recent activity' },
  taskStatusPending: { zh: '待处理', en: 'Pending' },
  taskStatusQueued: { zh: '排队中', en: 'Queued' },
  taskStatusProcessing: { zh: '处理中', en: 'Processing' },
  taskStatusCompleted: { zh: '已完成', en: 'Completed' },
  taskStatusFailed: { zh: '失败', en: 'Failed' },
  taskStatusCancelled: { zh: '已取消', en: 'Cancelled' },
  experimentStatusActive: { zh: '进行中', en: 'Active' },
  experimentStatusArchived: { zh: '已归档', en: 'Archived' },
  experimentStatusDraft: { zh: '草稿', en: 'Draft' },
  experimentStatusCompleted: { zh: '已完成', en: 'Completed' },
  experimentStatusUpdated: { zh: '已更新', en: 'Updated' },
  activityTaskMessage: { zh: '任务 {id} {status}', en: 'Task {id} {status}' },
  activityAssetMessage: { zh: '{name} 素材已生成', en: '{name} asset generated' },
  activityExperimentMessage: { zh: '实验 {name} {status}', en: 'Experiment {name} {status}' },
